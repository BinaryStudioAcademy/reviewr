...
<body>
Hello, {{$first_name}} {{$last_name}} . <b>You have a new user, who want to review your request: {{$request_title}}</b>>. <hr>
                            ...
                            <tr>
                                <td class="padded" style="padding: 0;vertical-align: top;padding-left: 50px;padding-right: 25px;word-break: break-word;word-wrap: break-word">
                                    <div class="image" style="font-size: 12px;Margin-bottom: 21px;mso-line-height-rule: at-least;color: #60666d;font-family: sans-serif" align="center">
                                        <img style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 480px" src="{{$avatar}}" alt="" width="225" height="225">
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <tbody>
                        <tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 25px;padding-right: 50px;word-break: break-word;word-wrap: break-word">
                                ...
                                <p style="Margin-top: 0;color: #60666d;font-size: 13px;font-family: sans-serif;">Name: {{$offer_first_name}} {{$offer_last_name}}</p>
                                <p style="Margin-top: 0;color: #60666d;font-size: 13px;font-family: sans-serif;">Job: {{$offer_job}}</p>
                                <p style="Margin-top: 0;color: #60666d;font-size: 13px;font-family: sans-serif;">Phone: {{$offer_phone}}</p>
                                <p style="Margin-top: 0;color: #60666d;font-size: 13px;font-family: sans-serif;">Email: {{$offer_email}}</p>
                                <p style="Margin-top: 0;color: #60666d;font-size: 13px;font-family: sans-serif;">Reputation: {{$offer_reputation}}</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
