...
Route::group (['prefix' => env('APP_PREFIX', '')], function () {
    ...
    Route::group([ 'prefix' => 'api/v1' ], function () {
        ...
        Route::resource('/reviewrequest/{rid}/comment', 'CommentController', ['only' => ['index', 'store', 'show']]);
        Route::resource('job', 'JobController', ['only' => ['index']]);
        Route::resource('department', 'DepartmentController', ['only' => ['index']]);
        Route::resource('reviewrequest', 'ReviewRequestController', ['except' => ['create', 'edit']]);
        ...
        Route::resource('badge', 'BadgeController', ['only' => ['index']]);
